...
@Injectable()
// @Injectable()：Guard 也可以作为 Provider，由 NestJS DI 管理。
// 将来可以注入 ConfigService、UsersService 等；V15 只读 Header，不注入 Prisma。
